    ...
    return (
        ...
        <div data-aos="zoom-in-up" className="relative flex flex-col my-6 bg-black text-white shadow-md border border-gray-700 rounded-lg overflow-hidden">
            ...
            <Link to={`/cars/${car._id}`} className="px-5 pb-5">
                <button className="w-full cursor-pointer py-2 font-semibold bg-gradient-to-r from-[#FF3600] to-[#ff3700d7] text-white hover:bg-gradient-to-l transition-all duration-300 border-none rounded-lg hover:scale-105">
                    Book Now
                </button>
            </Link>
        </div>
